  ...
  return (
    <>
      <div className="subheader_container">
        ...
        <Sidenav close={closeSidenav} clas={clas} />
        <span className="subheader_option" onClick={setData}>
          All
        </span>
        <span
          className="subheader_option"
        ...
        <span className="subheader_option" onClick={() => filterItem("books")}>
          Books
        </span>{" "}
        <span
          className="subheader_option"
        ...
        <span className="subheader_option" onClick={() => filterItem("toys")}>
          Toys and Games
        </span>
        <span
          className="subheader_option"
